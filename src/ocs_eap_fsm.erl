...
idle(timeout, #statedata{radius_fsm = RadiusFsm, radius_id = RadiusID,
	...
	AttributeList2 = radius_attributes:store(?MessagesAuthenticator,
			lists:duplicate(16, 0), AttributeList1),
	Response1 = #radius{code = ?AccessChallenge, id = RadiusID,
			authenticator = RequestAuthenticator, attributes = AttributeList2},
	ResponsePacket1 = radius:codec(Response1),
	MessageAuthenticator = crypto:hmac(md5, Secret, ResponsePacket1),
	AttributeList3 = radius_attributes:store(?MessagesAuthenticator,
