...
%%% 	messages for the 3GPP DIAMETER SWx application
...
prepare_request(Packet, _ServiceName, _Peer, _Fsm) ->
	{send, Packet}.
...
process_request(ServiceName, ServerAddress, ServerPort, ClientAddress,
		...
		#'3gpp_swx_RTR'{'Session-Id' = SessionId} = Request) ->
	try
		...
		_:_Reason ->
			{reply, #'3gpp_swx_RTA'{'Session-Id' = SessionId,
...
process_request1(ServiceName, ServerAddress, ServerPort, ClientAddress,
	...
	case supervisor:start_child(Sup, ChildSpec) of
		...
		{error, Reason} ->
			error_logger:error_report(["Error starting HSS session handler",
