...
%%% 	for the STa interface in the {@link //ocs. ocs} application.
%%%
-module(ocs_diameter_codec_sta).
...
'APN-Configuration'(encode = Operation, 'Grouped' = _Type,
	...
	Mod:grouped_avp(Operation, 'APN-Configuration', Data);
'APN-Configuration'(encode = Operation, 'Grouped' = _Type,
		#'3gpp_sta_APN-Configuration'{} = Data) ->
	Mod = diameter_gen_3gpp_sta_application,
	Mod:grouped_avp(Operation, 'APN-Configuration', Data).
...
-spec 'EPS-Subscribed-QoS-Profile'(Operation, Type, Data) -> Result
	when
		...
		Data :: binary() | #'3gpp_swx_EPS-Subscribed-QoS-Profile'{}
				| #'3gpp_sta_EPS-Subscribed-QoS-Profile'{},
		Result :: {#'3gpp_sta_EPS-Subscribed-QoS-Profile'{}, list()} | binary().
...
'EPS-Subscribed-QoS-Profile'(encode = Operation, 'Grouped' = _Type,
	...
	Mod:grouped_avp(Operation, 'EPS-Subscribed-QoS-Profile', Data);
'EPS-Subscribed-QoS-Profile'(encode = Operation, 'Grouped' = _Type,
		#'3gpp_sta_EPS-Subscribed-QoS-Profile'{} = Data) ->
	Mod = diameter_gen_3gpp_sta_application,
	Mod:grouped_avp(Operation, 'EPS-Subscribed-QoS-Profile', Data).
...
-spec 'AMBR'(Operation, Type, Data) -> Result
	when
		Operation :: decode | encode,
		Type :: 'Grouped',
		Data :: binary() | #'3gpp_swx_AMBR'{} | #'3gpp_sta_AMBR'{},
		Result :: {#'3gpp_sta_AMBR'{}, list()} | binary().
...
-spec 'Specific-APN-Info'(Operation, Type, Data) -> Result
	when
		...
		Data :: binary() | #'3gpp_swx_Specific-APN-Info'{}
				| #'3gpp_sta_Specific-APN-Info'{},
		Result :: {#'3gpp_sta_Specific-APN-Info'{}, list()} | binary().
...
'Specific-APN-Info'(encode = Operation, 'Grouped' = _Type,
	...
	Mod:grouped_avp(Operation, 'Specific-APN-Info', Data);
'Specific-APN-Info'(encode = Operation, 'Grouped' = _Type,
		#'3gpp_sta_Specific-APN-Info'{} = Data) ->
	Mod = diameter_gen_3gpp_sta_application,
	Mod:grouped_avp(Operation, 'Specific-APN-Info', Data).
...
-spec 'WLAN-offloadability'(Operation, Type, Data) -> Result
	when
		...
		Data :: binary() | #'3gpp_swx_WLAN-offloadability'{}
				| #'3gpp_sta_WLAN-offloadability'{},
		Result :: {#'3gpp_sta_WLAN-offloadability'{}, list()}.
...
'WLAN-offloadability'(encode = Operation, 'Grouped' = _Type,
	...
	Mod:grouped_avp(Operation, 'WLAN-offloadability', Data);
'WLAN-offloadability'(encode = Operation, 'Grouped' = _Type,
		#'3gpp_sta_WLAN-offloadability'{}= Data) ->
	Mod = diameter_gen_3gpp_sta_application,
	Mod:grouped_avp(Operation, 'WLAN-offloadability', Data).
...
-spec 'Trace-Info'(Operation, Type, Data) -> Result
	when
		Operation :: decode | encode,
		Type :: 'Grouped',
		Data :: binary() | #'3gpp_swx_Trace-Info'{} | #'3gpp_sta_Trace-Info'{},
		Result :: {#'3gpp_sta_Trace-Info'{}, list()} | binary().
...
-spec 'Emergency-Info'(Operation, Type, Data) -> Result
	when
		Operation :: decode | encode,
		Type :: 'Grouped',
		Data :: binary() | #'3gpp_swx_Emergency-Info'{} | #'3gpp_sta_Emergency-Info'{},
		Result :: {#'3gpp_sta_Emergency-Info'{}, list()} | binary().
...
-spec 'Subscription-Id'(Operation, Type, Data) -> Result
	when
		Operation :: decode | encode,
		Type :: 'Grouped',
		Data :: binary() | #'3gpp_swx_Subscription-Id'{} | #'3gpp_sta_Subscription-Id'{},
		Result :: {#'3gpp_sta_Subscription-Id'{}, list()} | binary().
