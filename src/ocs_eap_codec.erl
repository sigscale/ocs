...
%% @doc Encode or Decode an EAP-PWD-Header packet transported in the RADIUS
...
-spec payload_id(Packet :: binary() | #eap_pwd_id{}) -> #eap_pwd_id{} | binary().
%% @doc Enocde or Decode `EAP-pwd-ID' 
%%
%% RFC-5931 3.2.1
...
payload_id(<<GDesc, RanFun, PRF, Token, PWDPrep, Id>>) ->
	#eap_pwd_id{
		...
		pwd_prep = PWDPrep,
		identity = Id};
payload_id(#eap_pwd_id{group_desc = GID, random_fun = RanFun, prf = PRF,
