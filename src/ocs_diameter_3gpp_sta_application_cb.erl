%%% ocs_diameter_3gpp_sta_application_cb.erl 
%%% vim: ts=3
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% @hidden
request(ServiceName, Capabilities,
		ServerAddress, ServerPort, #'3gpp_sta_DER'{} = Request, [H | T]) ->
...
request(ServiceName, Capabilities,
		ServerAddress, ServerPort, #'3gpp_sta_STR'{} = Request, [H | _]) ->
	process_request(ServiceName, Capabilities,
...
-spec process_request(ServiceName, Capabilities,
	...
	when
		...
		Request :: #'3gpp_sta_DER'{} | #'3gpp_sta_STR'{},
...
process_request(ServiceName,
		...
		#'3gpp_sta_STR'{'Session-Id' = SessionId,
	...
	try
		...
		_:_Reason ->
			{reply, #'3gpp_sta_STA'{'Session-Id' = SessionId,
					'Result-Code' = ?'DIAMETER_BASE_RESULT-CODE_INVALID_AVP_BITS',
					'Origin-Host' = OHost, 'Origin-Realm' = ORealm}}
	end.
%% @hidden
