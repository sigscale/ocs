...
radius_accouting(Config) ->
	...
	{ok, [{radius, AcctAddress, AcctPort, _}]} = application:get_env(ocs, radius_acct_config),
...
disconnect_session(Config) ->
	...
	_RADAcct_packet22 = radius:codec(RADAcct_Rec22),
	...
	{ok, {_, _, _RADAcct_response2}} = gen_udp:recv(Socket, 0),
