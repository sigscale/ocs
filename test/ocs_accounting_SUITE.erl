...
radius_accouting(Config) ->
	...
	IDReqAttributeList2 = radius_attributes:store(?NasIdentifier, "tomba123", IDReqAttributeList1),
	...
	RADAcctAttributes4 = radius_attributes:store(?NasIdentifier, "xray@point1", RADAcctAttributes3),
...
disconnect_session(Config) ->
	...
	RADAcctAttributes17 = radius_attributes:store(?NasIdentifier, "xray@point1", RADAcctAttributes16),
	...
	RADAcctAttributes27 = radius_attributes:store(?NasIdentifier, "xray@point1", RADAcctAttributes26),
	...
	RADAcct_stop_packet = radius:codec(RADAcct_stop_rec),
	ok = gen_udp:send(Socket, AcctAddress, AcctPort, RADAcct_stop_packet),
	{ok, Socket1} = gen_udp:open(3799, [{active, false}, inet, {ip, AuthAddress}, binary]), 
