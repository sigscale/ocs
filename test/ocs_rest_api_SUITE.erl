...
get_subscriber_balance(Config) ->
	...
	Identity = ocs:generate_identity(),
	Password = ocs:generate_password(),
	Buckets = [#bucket{units = cents, remain_amount = 10000000000},
			#bucket{units = cents, remain_amount = 5000000}],
...
update_subscriber_password_json_patch(Config) ->
	...
	ExtraAttributes = Attributes -- SortedAttributes,
	SortedAttributes = lists:sort(Attributes -- ExtraAttributes),
	{"totalBalance", Buckets1} = lists:keyfind("totalBalance", 1, Object),
	...
	ExtraAttributes = Attributes -- SortedAttributes,
	SortedAttributes = lists:sort(Attributes -- ExtraAttributes),
	{"totalBalance", Buckets1} = lists:keyfind("totalBalance", 1, Object1),
