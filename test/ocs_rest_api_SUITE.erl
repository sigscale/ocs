...
get_subscriber(Config) ->
	...
	ExtraAttributes = Attributes -- SortedAttributes,
	SortedAttributes = lists:sort(Attributes -- ExtraAttributes),
	{"totalBalance", {struct, TotalBalance}} = lists:keyfind("totalBalance", 1, Object),
	Amount = lists:keyfind("amount", 1, TotalBalance),
	Units = lists:keyfind("units", 1, TotalBalance),
	{"enabled", Enable} = lists:keyfind("enabled", 1, Object),
	{"multisession", Multi} = lists:keyfind("multisession", 1, Object).
...
update_subscriber_password_json_patch(Config) ->
	...
	ExtraAttributes = Attributes -- SortedAttributes,
	SortedAttributes = lists:sort(Attributes -- ExtraAttributes),
	{"totalBalance", Balance} = lists:keyfind("totalBalance", 1, Object1),
...
update_subscriber_attributes_json_patch(Config) ->
	...
	{"totalBalance", NewBalance} = lists:keyfind("totalBalance", 1, Object1),
...
add_product(Config) ->
	...
	OrderDate = {"orderDate", ocs_rest:iso8601(erlang:system_time(?MILLISECOND))},
	...
	ReqJson = {struct, [ProdName, ProdDescirption, ProdHref, IsBundle, IsCustomerVisible, 
			OrderDate, StartDate, ValidFor, ProdSpec, Status, ProdOfferPrice]},
...
get_product(Config) ->
	...
	OrderDate = lists:keyfind("orderDate", 1, ProductObj),
