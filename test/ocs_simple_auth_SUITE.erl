...
simple_authentication(Config) ->
	...
	A2 = radius_attributes:store(?NasPortId, "wlan1", A1),
	A3 = radius_attributes:store(?NasPortType, 19, A2),
	A4 = radius_attributes:store(?UserName, PeerID, A3),
	A5 = radius_attributes:store(?AcctSessionId, "826005e0", A4),
	A6 = radius_attributes:store(?CallingStationId, CallingStationId, A5),
	A7 = radius_attributes:store(?CalledStationId, CalledStationId, A6),
...
out_of_credit(Config) ->
	...
	A3 = radius_attributes:store(?NasPortType, 19, A2),
	A4 = radius_attributes:store(?UserName, PeerID, A3),
	A5 = radius_attributes:store(?AcctSessionId, "826005e1", A4),
	A6 = radius_attributes:store(?CallingStationId, CallingStationId, A5),
	A7 = radius_attributes:store(?CalledStationId, CalledStationId, A6),
	A8 = radius_attributes:store(?UserPassword, UserPassword, A7),
	A9 = radius_attributes:store(?NasIdentifier, NasId, A8),
...
bad_password(Config) ->
	...
	A3 = radius_attributes:store(?NasPortType, 19, A2),
	A4 = radius_attributes:store(?UserName, PeerID, A3),
	A5 = radius_attributes:store(?AcctSessionId, "826005e2", A4),
	A6 = radius_attributes:store(?CallingStationId, CallingStationId, A5),
	A7 = radius_attributes:store(?CalledStationId, CalledStationId, A6),
...
unknown_username(Config) ->
	...
	A5 = radius_attributes:store(?AcctSessionId, "826005e3", A4),
	A6 = radius_attributes:store(?CallingStationId, CallingStationId, A5),
	A7 = radius_attributes:store(?CalledStationId, CalledStationId, A6),
	A8 = radius_attributes:store(?UserPassword, UserPassword, A7),
	A9 = radius_attributes:store(?NasIdentifier, NasId, A8),
