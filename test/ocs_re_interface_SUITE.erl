...
nrf_post_final_ecur_class_b(MSISDN, IMSI, Messages) ->
	NF = {struct, [{"nodeFunctionality", "OCF"}]},
...
nrf_post_initial_scur_class_b(MSISDN, IMSI) ->
	...
	SubscriptionId = {array,
			["msisdn-" ++ MSISDN,
			"imsi-" ++ IMSI]},
	MCCMNC = {struct, [{"mcc", "001"}, {"mnc", "001"}]},
	TAI = {struct, [{"plmnId", MCCMNC}, {"tac", "40de"}]},
	ECGI = {struct, [{"plmnId", MCCMNC},
			{"eutraCellId", "7ac489f"}]},
	Location = {struct, [{"tai", TAI}, {"ecgi", ECGI}]},
	ULI = {struct, [{"eutraLocation", Location}]},
	ServiceInformation = {struct, [{"sgsnMccMnc", MCCMNC},
...
nrf_post_update_scur_class_b(MSISDN, IMSI, InputOctets, OutputOctets) ->
	...
	ServiceRating = {array,
			...
			{struct,
               ...
               {"requestSubType", "DEBIT"},
					{"consumedUnit", {struct,
							[{"totalVolume", InputOctets + OutputOctets},
