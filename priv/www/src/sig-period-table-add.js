...
class tablePeriodAdd extends PolymerElement {
	static get template() {
		return html`
			<style include="style-element"></style>
			<paper-dialog id="addPeriodTableModal" modal>
				<app-toolbar>
	...
	_addTableResponse(event) {
		this.$.addPeriodTableModal.close();
	}
...
window.customElements.define('sig-period-table-add', tablePeriodAdd);
