...
class tableRateAdd extends PolymerElement {
	static get template() {
		return html`
			<style include="style-element"></style>
			<paper-dialog id="addRateTableModal" modal>
				<app-toolbar>
					<h2>Add Rate Table</h2>
				</app-toolbar>
				<paper-progress
						indeterminate
						class="slow red"
...
window.customElements.define('sig-rate-table-add', tableRateAdd);
